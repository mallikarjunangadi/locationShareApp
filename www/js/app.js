...
angular.module('starter', ['ionic', 'starter.controller', 'starter.global', 'starter.services', 'starter.filter', 'ngCordova', 'ion-floating-menu']).run(function($ionicPlatform, $rootScope) {
